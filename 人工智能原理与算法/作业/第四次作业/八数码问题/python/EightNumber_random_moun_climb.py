# -*- coding: utf-8 -*-
"""
Created on Wed Nov 18 20:23:38 2020
...
def main():
    title = "EightPuzzle_random_moun_climb"
    startTime = time.perf_counter()
    successCase = 0
    totalCase = 0
    result = title + " result:\n\n"
    with open("E:\研究生\研一\上半学年\人工智能原理与算法\作业\第四次作业\八皇后和八数码问题\八数码问题\eightPuzzleTest.txt", "r") as ins:
        for line in ins:
            print("case= %d" % (totalCase))
            global FAILED
            FAILED = False
            totalCase += 1
            board = []
